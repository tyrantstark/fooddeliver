...
router.post("/", async (req, res) => {
  ...
  User.findOne({ email }, async (err, user) => {
    if (err) {
      ...
      let link = `${process.env.BASE_URL}/forget/${code}`;
      ...
      var mailOptions = {
        ...
        html:
          ...
          link +
          " >Link</a> to reset your passowrd.</p><p>If this request is not made by you kindly ignore this mail.</p><p>Regards, <strong>Food Eazy</strong></p>",
      };
